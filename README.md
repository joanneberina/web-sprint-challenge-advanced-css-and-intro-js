...
> Accessibility is how users with disability access electronic information and how web content designers and developers enable web pages to function with assistive devices such as screen readers, speech recognition devices, Braille terminals or alternative keyboards that are used by individuals with disabilites.

2. Talk about 3 different things you can do to ensure your website is accessible. 
> Use semantic markup to enable readability, ensuring that text flows well and carries a clear meaning

> Use Alt Text on Images

> Choose color carefully. Avoid bright colors and keep a clear contrast for readability.

3. How would you explain the concept of a variable to someone new to programming?
> A variable is a name of a value. You have to give it a name so you now what to call it.

4. What is the purpose of using functions in code?
>  It's giving instructions on how to do something that you can reuse.
